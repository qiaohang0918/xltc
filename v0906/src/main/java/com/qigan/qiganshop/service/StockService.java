...
public interface StockService {
    ...
    List<Stock> findEnabledStockByItemIdsAndWarehouseCode(String skuIdsConstructed, String warehouseCode);

    Integer increQuestionsRefundOrderItemsStock(OrderItem orderItem, String warehouseCode);
}
