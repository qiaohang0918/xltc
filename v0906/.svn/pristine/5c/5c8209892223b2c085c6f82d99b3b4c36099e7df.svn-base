...
public class LabelController {
    ...
    @ApiOperation(
            ...
            httpMethod = "POST")
    public JsonResult findUnionGoods(String categoryId, String labelId, String coni, CommonPage page) {
        if (categoryId != null
                && !"".equals(categoryId)
                && labelId != null
                && !"".equals(labelId)) {
            return jr.jsonResultData(ResultCode.SUCCESS.res_code(), ResultCode.SUCCESS.message(), goodsService.findUnionGoods(categoryId, labelId, page));
        }
    ...
    @RequestMapping("/findGoodsByCateId")
    public XltcResult findGoodsByCateId(String cateId, CommonPage page){
    	return service.findUnitGoodsByCateId(cateId, page);
    }
