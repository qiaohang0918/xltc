...
//		map.put("data",data);
	...
	public String getUserId(String phone) {
		String userId = userMapper.getUserId(phone);
		return userId;
	}

	@Override
	public int reGivenUserAmount(String userId, String total) {
		return userMapper.reGivenUserAmount(userId,total);
	}

	@Override
	public int onlyRefundBalance(String userId, String money) {
		return userMapper.refundUserBalance(userId,money);
	}
	 ...
	 */
	@Override
	public int updateMemberInfo(AppUser user) {
		return userMapper.updateMemberInfo(user);
	}
