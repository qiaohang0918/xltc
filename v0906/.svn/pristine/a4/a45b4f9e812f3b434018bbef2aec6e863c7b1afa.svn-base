...
public class XltcExplandControler {
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/dateCenterfindExplandUsers.do",method = RequestMethod.GET)
    public XltcResult dateCenterfindExplandUsers(String startTime,String endTime,String phone) throws IOException {
        List<TbExpland> list = expladService.exportExcelFindExplandUsers(startTime,endTime,phone);
        return XltcResult.ok(list);
    }
