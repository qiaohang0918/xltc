...
public interface AppUserMapper {
    ...
    @Select("select * from tb_user where userId in ( ${clueUserIds} ) ${timeConditional} ")
    List<AppUser> findUserByIds(@Param("clueUserIds") String clueUserIds, @Param("timeConditional") String timeConditional);
    ...
    @Update("update tb_user set member = #{user.member} , mbeginTime = #{user.mbeginTime} , mendTime=#{user.mendTime}  where userId = #{user.userId} ")
