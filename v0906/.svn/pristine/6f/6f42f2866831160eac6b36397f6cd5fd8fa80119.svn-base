...
import com.qigan.qiganshop.enums.BannerType;
...
public class BannerController {
    ...
    @RequestMapping("/insertAlertAds.do")
    @ApiOperation(
    		value = "插入首页广告位弹窗",
    		notes = "type类型，typeId 该类型对应的id，itemId该类型对应的商品编号 ;image 图片地址; url跳转地址",
    		httpMethod = "POST")
    public JsonResult insertAlertAds(Banner banner) {
    ...
    @RequestMapping("/updateAlertAds.do")
    @ApiOperation(
    		value = "插入首页广告位弹窗",
    		notes = "type类型，typeId 该类型对应的id，itemId该类型对应的商品编号 ;image 图片地址; url跳转地址",
    		httpMethod = "POST")
    public JsonResult updateAlertAds(Banner banner) {
    ...
    @RequestMapping("/enabelTask4Banner.do")
    public XltcResult enabelTask4Banner(Integer id, String startDate, String endDate){
    	bannerService.enabelTask4Banner(id, startDate, endDate);
    	return XltcResult.ok();
    }
    
    @RequestMapping("/delEnabelTask.do")
    public XltcResult delEnabelTask(Integer id){
    	bannerService.delEnabelTask(id);
    	return XltcResult.ok();
    }
    
    @RequestMapping("/findAllBannerByType.do")
    public XltcResult findAllBannerByType(String moduleType, CommonPage page){
    	return XltcResult.ok(bannerService.findAllBannerByType(moduleType, page));
    }
    
    @RequestMapping("/deleteBannerById.do")
    public XltcResult deleteBannerById(Integer id){
    	bannerService.deleteBannerById(id);
    	return XltcResult.ok();
    }
    
    @RequestMapping("/findModelTypeList.do")
    public List<?> findAllBannerModelTypeByList() {
    	return BannerModuleType.selectAllBannerModelTypeByList();
    }
    
    @RequestMapping("/findModelTypeMap.do")
    public Map<?, ?> findAllBannerModelTypeByMap() {
    	return BannerModuleType.selectAllBannerModelTypeByMap();
    }
    
    @RequestMapping("/findTypeList.do")
    public List<?> findAllBannerTypeByList() {
    	return BannerType.selectAllBannerTypeByList();
    }
    
    @RequestMapping("/findTypeMap.do")
    public Map<?, ?> findAllBannerTypeByMap() {
    	return BannerType.selectAllBannerTypeByMap();
    }
